...
<div class="RegistrationMain">
    ...
    <form action="{{url('registerUser')}}" method="post" class="flex flex-col mx-auto p-5 w-1/4 border border-slate-400 m-4 rounded p-4">
        ...
        <input class="rounded bg-transparent active:outline:none" type="text" name="name" id="name" value="{{old('name')}}" class="form-control">
        <span class="text-red">@error('name') {{$message}} @enderror</span>
        ...
        <span class="text-red">@error('number') {{$message}} @enderror</span>
