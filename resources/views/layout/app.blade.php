...
<body class="bg-slate-950 text-slate-100 min-h-screen flex flex-col font-sans selection:bg-indigo-500/30 selection:text-white">
    {{-- Include Header --}}
    ...
    @if(Request::is('dashboard*'))
        <div class="flex flex-col w-full min-h-screen bg-[#0c0d10]">
